                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-sm-12">
                                                ...
                                                {{ text_field("titulo", 'required': true, "value": noticia.get('titulo'), "width": '100%', "class": 'form-control') }}
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-sm-12">
                                                ...
                                                {{ text_area("texto", "class": 'form-control tinymce-editor',  "value":noticia.get('texto'))  }}
                                            </div>
                                        </div>
                                    </div>{#/.panel-body#}
                                </div>{#/.panel#}
